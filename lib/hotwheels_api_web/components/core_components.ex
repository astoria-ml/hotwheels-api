defmodule HotwheelsApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HotwheelsApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HotwheelsApiWeb.Gettext, "errors", msg, opts)
    end
  end
